const data = [
  ...
  { type: 'Website', value: 'https://www.abc.co/', icon: '/svg/world.svg' },
]

const dataX = [
  { type: 'Email', value: 'carr@gmail.co', icon: '/svg/mail.svg' },
  { type: 'Contact', value: '+1 123456789', icon: '/svg/phone.svg' },
]
...
function InfoList({ data }) {
  return (
    <div className="flex lg:flex-row flex-col lg:space-y-0 space-y-4">
      {data.map((info) => (
        <div key={info.type} className=" flex flex-row justify-between lg:w-4/12 ">
        ...
        <div className="flex lg:flex-row flex-col ">
          <div className="flex flex-col space-y-7 ">
            ...
            <p className="text-sm font-normal text-theme-black lg:w-7/12">
              Have a question on your mind? We are here to provide answers and
